...
const SearchPage = () => {
  ...
  return (
    ...
    <div className='py-16 '>
      ...
      <div className='container mx-auto justify-center items-center lg:pl-20'>
      <h3 className='capitalize text-lg lg:text-xl font-semibold my-3 '> Search Result</h3>
      <div className=' grid grid-cols-[repeat(auto-fit,230px)] gap-6 lg:gap-8 justify-center lg:justify-start'>
          {
